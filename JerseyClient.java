...
public class JerseyClient {
    private static final String baseUrl = "http://localhost:8080/drpatient";
	...
	getOneDemo(resource);
	deleteDemo(resource); // delete id = 4
    }
	...
	form.add("doctor", "Joshua");
	form.add("first", "Allen Smith");
    form.add("second","Sharon Smith");
	form.add("third","Aaron Costa");
